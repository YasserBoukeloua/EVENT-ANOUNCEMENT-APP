...
class _PostDetailsState extends State<PostDetails> {
  ...
  final comments = [
    ...
    Comment('sarah johnson', 'Great event! See you there 🎉', '4h', true),
    Comment('ahmed benali', 'Thanks for organizing this!', '6h'),
    Comment('emma wilson', 'Looking forward to networking', '8h'),
  ];
  ...
  Widget _buildInfoCard() => _roundedCard(
        Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text(widget.event.nameOfevent ?? 'Event',
              ...
              Expanded(
                child: Row(children: [
                  const Icon(Icons.location_on,
                      color: Color(0xFF230C33), size: 22),
                  const SizedBox(width: 6),
                  Expanded(
                    child: Text(widget.event.location ?? 'Location',
                        style: const TextStyle(
                            color: Color(0xFF230C33), fontSize: 16),
